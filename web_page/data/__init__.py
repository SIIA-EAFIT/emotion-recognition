...
class Dataset:
    ...
    def download_kaggle_dataset(self):
        ...
        """
        subprocess.check_output("kaggle competitions download -c challenges-in-representation-learning-facial-expression-recognition-challenge".split(" "))
    ...
    def get_next_batch(self):
        ...
        end = min([(self.current_batch + 1) * self.batch_size, self.data_length])  # index of the last image in this batch
