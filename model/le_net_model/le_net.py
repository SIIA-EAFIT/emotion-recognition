...
class LeNetModel:
    ...
    def __init__(self):
        ...
        self.feature_columns = {tf.feature_column.numeric_column('image', shape=(1, 48, 48, 1))}
    ...
    def _model_fn(self, features, labels, mode, params):
        ...
        conv1 = tf.layers.conv2d(inputs=input_layer, filters=6, kernel_size=(5, 5), 
        ...
        dropout = tf.layers.dropout(inputs=fc2, rate=0.2, training = mode == tf.estimator.ModeKeys.TRAIN)
